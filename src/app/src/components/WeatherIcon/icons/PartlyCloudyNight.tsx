...
const PartlyCloudyNight: React.FC<IProps> = ({ theme }) => {
    return (
        ...
        <path d="M6.77,19.65c0-0.79,0.23-1.48,0.68-2.09c0.45-0.61,1.06-1.03,1.81-1.27c0.32-1.09,0.98-1.92,1.99-2.49v-0.35
            ...
            c-0.57,0.26-1.05,0.64-1.44,1.12l-0.03-0.02C13.55,11.56,13.25,12.35,13.18,13.25z" fill={theme === "dark" ? "white" : "black" } />
        </svg>
    )
}
